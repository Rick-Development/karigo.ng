  ...
  Widget build(BuildContext context) {
    ...
    final Map<String, Map<String, Widget>> widgetMap =
      ...
      'blog': <String, Widget>{
        ...
        PsWidgetConst.blog_product_slider_component: CustomBlogProductSliderListWidget(
          animationController: animationController,
        ),
      },
      'product': <String, Widget>{
        ...
        PsWidgetConst.nearest_item_horizontal_list_component: CustomNearestProductHorizontalListWidget(
          animationController: animationController,
        ),
        ...
        PsWidgetConst.recent_item_horizontal_list_component: CustomRecentProductHorizontalListWidget(
          animationController: animationController!,
        ),
      ...
      'common': <String, Widget>{
        PsWidgetConst.search_and_header_component: CustomHomeSearchHeaderWidget(
          animationController: animationController,
        ),
      ...
      'user': <String, Widget>{
        ...
        PsWidgetConst.vendor_card_component: CustomVendorApplicationCard(),
      ...
      'vendor': <String, Widget>{
        PsWidgetConst.vendor_horizontal_list_component: CustomLatestVendorListWidget(
            animationController: animationController)
      },
