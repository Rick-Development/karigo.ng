...
class PsColors {
  ...
  /// Primary Colors
  ///
  static Color primary50 = const Color(0xFFFEDC00);
  static Color primary100 = const Color(0xFFFEDC00);
  static Color primary200 = const Color(0xFFFEDC00);
  static Color primary300 = const Color(0xFFFEDC00);
  static Color primary400 = const Color(0xFFFEDC00);
  static Color primary500 = const Color(0xFFFEDC00);
  static Color primary600 = const Color(0xFFFEDC00);
  static Color primary700 = const Color(0xFFFEDC00);
  static Color primary800 = const Color(0xFFFEDC00);
  static Color primary900 = const Color(0xFFFEDC00);
