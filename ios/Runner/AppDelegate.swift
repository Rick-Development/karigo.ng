...
//     BTAppContextSwitcher.setReturnURLScheme("rickdevelopment.karigo.braintree")
...
//     if url.scheme?.localizedCaseInsensitiveCompare("rickdevelopment.karigo.braintree") == .orderedSame {
